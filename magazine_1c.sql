...
--
-- Хост: localhost:3306
-- Время создания: Дек 10 2024 г., 23:31
...
(1, '1С:Бухгалтерия 8 ПРОФ', 'Профессиональная версия для ведения бухгалтерского и налогового учета', '13000.00', 'icons/1c_buh.png', '1С:Предприятие', '3.0.121', '0', '2024-11-25 19:17:15', 'active', 31),
(2, '1С:Зарплата и управление персоналом 8', 'Комплексное решение для расчета зарплаты и кадрового учета', '22600.00', 'icons/1c_zp.jpg', '1С:Предприятие', '3.1.20', '0', '2024-11-25 19:17:15', 'active', 9),
(3, '1С:Управление торговлей', 'Система автоматизации торговых операций', '22600.00', 'icons/1c_ypr.jpg', '1С:Предприятие', '11.4.10', '0', '2024-11-25 19:17:15', 'active', 12),
